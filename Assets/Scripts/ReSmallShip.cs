...
public class ReSmallShip : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        if (StartMovement == true)
        {
            ...
            if (this.gameObject.transform.position.x < 11 && this.gameObject.transform.position.y < 11 && this.gameObject.transform.position.x > -11 && this.gameObject.transform.position.y > -11)
            {
                StartMovement = false;
            }
